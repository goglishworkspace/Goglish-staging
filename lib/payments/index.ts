...
// actually process a real payment - only register them when a developer/test
// run has explicitly opted in, so they're never selectable in production
// regardless of what a request sends as `provider`.
