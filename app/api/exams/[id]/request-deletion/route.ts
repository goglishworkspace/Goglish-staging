...
export async function POST(_request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (exam.deletion_requested_at) return apiSuccess(exam, "طلب الحذف مبعوت بالفعل ومنتظر مراجعة الأدمن");
