...
/** Shared between the public marketing page (app/(marketing)/honor-board)
 * and the student/parent dashboard pages - a dashboard sidebar link that
 * pointed straight at the marketing route would swap out the whole
 * dashboard shell (sidebar/topbar) for the public Navbar/Footer, which
 * reads as "leaving" the dashboard. Each dashboard route renders this same
 * content inside its own layout instead. */
export function HonorBoardContent({ leaderboardHref = "/leaderboard" }: { leaderboardHref?: string }) {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-8 text-center text-small text-muted-foreground">
        ...
        <Link href={leaderboardHref} className="font-semibold text-primary underline">
